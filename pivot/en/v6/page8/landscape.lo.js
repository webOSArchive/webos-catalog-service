[
	{kind: "VFlexBox", className: "landscape", style: "background-image: url({$landscapeBgImage});width:1024px;height:768px;", components: [
    	...
    	{kind: "enyo.FindApps.Magazine.BindableLayout", className: "index-app5 hidden", templatePath: "{$appTemplate}", bindingPath: "{$app5BindingsLandscape}"},
    	{kind: "enyo.FindApps.Magazine.BindableLayout", className: "index-app6 hidden", templatePath: "{$appTemplate}", bindingPath: "{$app6BindingsLandscape}"},
    	{kind: "enyo.FindApps.Magazine.BindableLayout", className: "index-app7 hidden", templatePath: "{$appTemplate}", bindingPath: "{$app7BindingsLandscape}"},
    	{kind: "enyo.FindApps.Magazine.BindableLayout", className: "index-app8 hidden", templatePath: "{$appTemplate}", bindingPath: "{$app8BindingsLandscape}"},
    	{kind: "enyo.FindApps.Magazine.BindableLayout", className: "index-app9 hidden", templatePath: "{$appTemplate}", bindingPath: "{$app9BindingsLandscape}"},
