    ...
    <div id="content" align="left">
      ...
      <div style="font-size:0.98em">
        ...
        <a class="download-link" href="showMuseum.php">
           ...
           | <a class="download-link" href="feed.php" title="RSS feed of new apps and updates"><img src="assets/rss.png">RSS Feed</a>
        <br><br>
        <div style="font-weight:bold; margin-bottom:8px;">Install on Device | <a href="http://docs.webosarchive.org/#step-5" style="vertical-align:middle;height:32px;width:32px;">Help</a><br></div>
