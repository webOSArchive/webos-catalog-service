    ...
    <div id="content" align="left">
      ...
      <div style="font-size:0.98em">
        ...
        <a class="download-link" href="showMuseum.php">
           ...
           | <a class="download-link" href="feed.php" title="RSS feed of new apps and updates"><img src="assets/rss.png" style="vertical-align:middle;height:32px;width:32px;">RSS Feed</a>
        <br><br>
