  ...
  <div id="row">
    <div id="content" align="left">
      ...
      <div style="font-size:-1">
        ...
        <a class="download-link" href="AppPackages/com.palm.app.enyo-findapps_6.0.2900_all.ipk"><img src="assets/hp-appcatalog.png" style="vertical-align:middle;height:48px;width:48px;" alt="HP App Catalog for TouchPad"" title="HP App Catalog for TouchPad">Restored App Catalog (3.0.x)</a><br>
        ...
        <a class="download-link" href="https://github.com/h8pewou/legacy-webos-feeds/blob/main/README.md#wosa-feed"><img src="assets/preware-icon.png" style="vertical-align:middle;height:48px;width:48px;" alt="PreWare Feed for Old Phones">PreWare Feed (Older Phones)</a><br>
